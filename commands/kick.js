module.exports = {
    run: async (message, args) => {
        ...
        if (member.id === message.guild.ownerID) return message.channel.send('Vous ne pouvez pas exclure le propriétaire du server.')
        ...
        message.channel.send(`${member.user.tag} a été exclu pour le motif "${reason}".`)
    },
    name: 'kick',
    guildOnly: true
}
